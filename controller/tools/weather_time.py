...
@tool(
    ...
    aliases=["show_timers", "get_timers"]
)
def list_timers() -> str:
    """
    ...
    return "Active timers: " + ", ".join(active_timers.keys())


@tool(
    name="get_timer_status",
    description="Get the status of a timer including time remaining",
    aliases=["timer_status", "check_timer"]
)
